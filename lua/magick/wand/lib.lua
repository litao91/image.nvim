...
get_filters = function()
  ...
  local prefixes = {
    "/usr/local/Cellar/imagemagick/7.1.1-21/include/ImageMagick-7/",
...
lib = try_to_load("MagickWand", function()
  local lname = "MagickWand-7.Q16HDRI.10"
  local suffix
  if ffi.os == "OSX" then
    suffix = ".dylib"
  ...
  return lname and "/usr/local/Cellar/imagemagick/7.1.1-21/lib/" .. "lib" .. lname .. suffix
end)
return {
  lib = lib,
